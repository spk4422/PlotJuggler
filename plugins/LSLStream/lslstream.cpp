...
LSLStream::LSLStream(lsl::stream_info stream_info)
{
    ...
    std::string stream_prefix = stream_info_.source_id()+ "/" +stream_info_.type();

    for (int i = 0; i < stream_info_.channel_count(); ++i)
    {
